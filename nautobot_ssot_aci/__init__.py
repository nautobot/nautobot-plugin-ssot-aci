...
from nautobot_ssot_aci.signals import aci_create_manufacturer, aci_create_site, aci_create_tag, aci_create_custom_field, aci_create_custom_field_pod
...
class NautobotSsotAciConfig(PluginConfig):
    ...
    def ready(self):
        ...
        nautobot_database_ready.connect(aci_create_custom_field_pod, sender=self)
