...
class DeviceType(DiffSyncModel):
    ...
    _identifiers = ("model", "manufacturer", "part_nbr",)
    _attributes = ("comments", "u_height",)
...
class Device(DiffSyncModel):
    ...
    _modelname = "device"
    _identifiers = ("name", "device_type", "device_role", "serial",)
...
class InterfaceTemplate(DiffSyncModel):
    ...
    _identifiers = ("device_type", "name", "type",)
    _attributes = ("u_height", "description", "mgmt_only",)
...
class IPAddress(DiffSyncModel):
    ...
    _identifiers = ("address", "status",)
    _attributes = ("description", "device", "interface", "tenant",)
...
class Prefix(DiffSyncModel):
    ...
    _modelname = "prefix"
    _identifiers = ("prefix", "status",)
    _attributes = ("description", "tenant",)
